...
class DetailTvScreen extends StatefulWidget {
  DetailTvScreen({Key? key, required this.id}) : super(key: key);
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      image: NetworkImage(
                                          'https://image.tmdb.org/t/p/w500${movieList.tvList[widget.id].poster_path}'),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    movieList.tvList[widget.id].media_type,
                                    style: detailText1,
                                  ),
                                ],
                              ),
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    movieList.tvList[widget.id].name,
                                    style: detailText1,
                                  ),
                                ],
                              ),
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    movieList.tvList[widget.id].overview,
                                    style: detailText1,
                                  ),
                                ],
                              ),
